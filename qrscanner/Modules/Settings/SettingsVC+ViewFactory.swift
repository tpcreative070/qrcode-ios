...
extension SettingsVC {
    func initUI(){
        ...
        NSLayoutConstraint.activate([
            self.imgMultiScan.topAnchor.constraint(equalTo: self.viewMultiScan.topAnchor,constant: AppConstants.MARGIN_TOP_ITEM_SETTING),
            self.imgMultiScan.bottomAnchor.constraint(equalTo: self.viewMultiScan.bottomAnchor,constant: AppConstants.MARGIN_BOTTOM_ITEM),
        ...
        //        viewMultiScan.backgroundColor = .yellow
        ...
        NSLayoutConstraint.activate([
            self.imgMultiLoad.topAnchor.constraint(equalTo: self.viewMultiLoad.topAnchor,constant: AppConstants.MARGIN_TOP_ITEM_SETTING),
            self.imgMultiLoad.bottomAnchor.constraint(equalTo: self.viewMultiLoad.bottomAnchor,constant: AppConstants.MARGIN_BOTTOM_ITEM),
            ...
            self.imgMultiLoad.heightAnchor.constraint(equalToConstant: AppConstants.ICON_WIDTH_HEIGHT),
                ...
                NSLayoutConstraint.activate([
                   self.imgChangeColor.topAnchor.constraint(equalTo: self.viewChangeColor.topAnchor,constant: AppConstants.MARGIN_TOP_ITEM_SETTING),
                ...
                NSLayoutConstraint.activate([
                    self.imgCopy.topAnchor.constraint(equalTo: self.viewCopy.topAnchor,constant: AppConstants.MARGIN_TOP_ITEM_SETTING),
                                       self.imgCopy.bottomAnchor.constraint(equalTo: self.viewCopy.bottomAnchor,constant: AppConstants.MARGIN_BOTTOM_ITEM),
                ...
                NSLayoutConstraint.activate([
                    self.imgWeb.topAnchor.constraint(equalTo: self.viewOpenWeb.topAnchor,constant: AppConstants.MARGIN_TOP_ITEM_SETTING),
                     self.imgWeb.bottomAnchor.constraint(equalTo: self.viewOpenWeb.bottomAnchor,constant: AppConstants.MARGIN_BOTTOM_ITEM),
                ...
                NSLayoutConstraint.activate([
                    self.imgLanguage.topAnchor.constraint(equalTo: self.viewLanguage.topAnchor,constant: AppConstants.MARGIN_TOP_ITEM_SETTING),
                        self.imgLanguage.bottomAnchor.constraint(equalTo: self.viewLanguage.bottomAnchor,constant: AppConstants.MARGIN_BOTTOM_ITEM),
