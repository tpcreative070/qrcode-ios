...
struct Helper {
    ...
    static func getValueShareContent(typeCode : String, content: ContentViewModel) -> String{
        if typeCode == EnumType.URL.rawValue{
            ...
            return "\(String(describing: LanguageHelper.getTranslationByKey(LanguageKey.Url)!)): \(urlModel.url ?? "")"
            ...
            return "\(String(describing: LanguageHelper.getTranslationByKey(LanguageKey.Text)!)): \(textModel.text ?? "")"
        }
            ...
            return "\(String(describing: LanguageHelper.getTranslationByKey(LanguageKey.Phone)!)): \(messageModel.to ?? "")\n\(String(describing: LanguageHelper.getTranslationByKey(LanguageKey.Message)!)): \(messageModel.message ?? "")"
        }
            ...
            return "\(String(describing: LanguageHelper.getTranslationByKey(LanguageKey.SSID)!)): \(wifiModel.ssid ?? "")\n\(String(describing: LanguageHelper.getTranslationByKey(LanguageKey.Password)!)): \(wifiModel.password ?? "")\n\(String(describing: LanguageHelper.getTranslationByKey(LanguageKey.NetworkEncryption)!)): \(wifiModel.protect ?? "")\n\(String(describing: LanguageHelper.getTranslationByKey(LanguageKey.Hidden)!)): \(String(describing: wifiModel.hidden))"
        }
            ...
            return "\(String(describing: LanguageHelper.getTranslationByKey(LanguageKey.Phone)!)): \(phoneModel.phone ?? "")"
        }
            ...
            return "\(String(describing: LanguageHelper.getTranslationByKey(LanguageKey.ProductID)!)): \(contactModel.productID ?? "")\n \(contactModel.barcodetype ?? "")"
        }
        else {
            return "No values"
        }
