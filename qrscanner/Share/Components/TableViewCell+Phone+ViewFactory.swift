...
extension TableViewCell  {
    ...
    func setupPhoneView(){
          self.addSubview(self.viewBackgroundSecond)
            ...
            viewBackgroundThird.addSubview(imgPhone)
            NSLayoutConstraint.activate([
                imgPhone.topAnchor.constraint(equalTo: viewBackgroundThird.topAnchor, constant: 10),
                imgPhone.leadingAnchor.constraint(equalTo: viewBackgroundThird.leadingAnchor, constant: AppConstants.MARGIN_LEFT),
                self.imgPhone.widthAnchor.constraint(equalToConstant: 30),
                self.imgPhone.heightAnchor.constraint(equalToConstant: 30),
                self.imgPhone.centerYAnchor.constraint(equalTo: self.viewBackgroundThird.centerYAnchor)
                
            ])
            viewBackgroundThird.addSubview(lbTitleSecond)
            NSLayoutConstraint.activate([
                lbTitleSecond.topAnchor.constraint(equalTo: viewBackgroundThird.topAnchor, constant: 10),
                lbTitleSecond.leadingAnchor.constraint(equalTo: imgPhone.trailingAnchor, constant: AppConstants.MARGIN_LEFT),
                lbTitleSecond.trailingAnchor.constraint(equalTo: viewBackgroundThird.trailingAnchor, constant:  AppConstants.MARGIN_RIGHT),
                self.lbTitleSecond.centerYAnchor.constraint(equalTo: self.viewBackgroundThird.centerYAnchor)
