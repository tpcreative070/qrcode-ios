...
extension TableViewCell  {
    ...
    func setupPhoneView(){
          self.addSubview(self.backGroundView1)
            ...
            NSLayoutConstraint.activate([
                phoneImg.topAnchor.constraint(equalTo: bgView1.topAnchor, constant: 10),
                phoneImg.leadingAnchor.constraint(equalTo: bgView1.leadingAnchor, constant: AppConstants.MARGIN_LEFT),
                self.phoneImg.widthAnchor.constraint(equalToConstant: 30),
                self.phoneImg.heightAnchor.constraint(equalToConstant: 30),
                self.phoneImg.centerYAnchor.constraint(equalTo: self.bgView1.centerYAnchor)
                
            ])
            bgView1.addSubview(titleLbl2)
            NSLayoutConstraint.activate([
                titleLbl2.topAnchor.constraint(equalTo: bgView1.topAnchor, constant: 10),
                titleLbl2.leadingAnchor.constraint(equalTo: phoneImg.trailingAnchor, constant: AppConstants.MARGIN_LEFT),
                titleLbl2.trailingAnchor.constraint(equalTo: bgView1.trailingAnchor, constant:  AppConstants.MARGIN_RIGHT),
                self.titleLbl2.centerYAnchor.constraint(equalTo: self.bgView1.centerYAnchor)
            ...
            bgView1.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(phoneAction(sender:))))
