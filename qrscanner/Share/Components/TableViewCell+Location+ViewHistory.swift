...
extension TableViewCell  {
    ...
    func setupLocationView(){
        ...
        NSLayoutConstraint.activate([
            ...
            self.imgLocation.widthAnchor.constraint(equalToConstant: AppConstants.ICON_WIDTH_HEIGHT),
            self.imgLocation.heightAnchor.constraint(equalToConstant: AppConstants.ICON_WIDTH_HEIGHT),
