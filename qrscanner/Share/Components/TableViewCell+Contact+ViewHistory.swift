    ...
    func setupContactView(){
        ...
        viewRoot.addSubview(lbTitleFour)
             ...
             self.viewBackgroundSecond.addSubview(viewBackgroundThird)
                 ...
                 NSLayoutConstraint.activate([
                     imgContact.topAnchor.constraint(equalTo: viewBackgroundThird.topAnchor, constant: 10),
                     imgContact.leadingAnchor.constraint(equalTo: viewBackgroundThird.leadingAnchor, constant: AppConstants.MARGIN_LEFT),
                     self.imgContact.widthAnchor.constraint(equalToConstant: 30),
                     self.imgContact.heightAnchor.constraint(equalToConstant: 30),
