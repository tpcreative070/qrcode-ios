...
extension TableViewCell  {
    ...
    func setupContactView(){
        ...
        NSLayoutConstraint.activate([
            ...
            self.viewBackgroundThird.topAnchor.constraint(equalTo: self.lbValueFour.bottomAnchor,constant: AppConstants.MARGIN_TOP),
        ...
        NSLayoutConstraint.activate([
            ...
            self.imgContact.widthAnchor.constraint(equalToConstant: DeviceHelper.Shared.ICON_WIDTH_HEIGHT),
            self.imgContact.heightAnchor.constraint(equalToConstant: DeviceHelper.Shared.ICON_WIDTH_HEIGHT),
            self.imgContact.centerYAnchor.constraint(equalTo: self.viewBackgroundThird.centerYAnchor)
            
        ])
        viewBackgroundThird.addSubview(lbTitleFive)
        NSLayoutConstraint.activate([
            lbTitleFive.topAnchor.constraint(equalTo: viewBackgroundThird.topAnchor, constant: AppConstants.MARGIN_TOP),
            lbTitleFive.leadingAnchor.constraint(equalTo: imgContact.trailingAnchor, constant: AppConstants.MARGIN_LEFT),
        ...
        viewBackgroundThird.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(addContactAction(sender:))))
