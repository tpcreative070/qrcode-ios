...
extension TableViewCell  {
    ...
    func setupContactView(){
        ...
        viewRoot.addSubview(titleLabel4)
             ...
             self.backGroundView1.addSubview(bgView1)
                       NSLayoutConstraint.activate([
                           ...
                           self.bgView1.topAnchor.constraint(equalTo: self.valueTxt4.bottomAnchor,constant: 20),
                           
                       ])

                 bgView1.addSubview(contactImg)
                 NSLayoutConstraint.activate([
                     contactImg.topAnchor.constraint(equalTo: bgView1.topAnchor, constant: 10),
                     contactImg.leadingAnchor.constraint(equalTo: bgView1.leadingAnchor, constant: AppConstants.MARGIN_LEFT),
                     self.contactImg.widthAnchor.constraint(equalToConstant: 30),
                     self.contactImg.heightAnchor.constraint(equalToConstant: 30),
                     self.contactImg.centerYAnchor.constraint(equalTo: self.bgView1.centerYAnchor)

                 ])
                 bgView1.addSubview(titleLabel5)
                 NSLayoutConstraint.activate([
                     titleLabel5.topAnchor.constraint(equalTo: bgView1.topAnchor, constant: 10),
                     titleLabel5.leadingAnchor.constraint(equalTo: contactImg.trailingAnchor, constant: AppConstants.MARGIN_LEFT),
                     titleLabel5.trailingAnchor.constraint(equalTo: bgView1.trailingAnchor, constant:  AppConstants.MARGIN_RIGHT),
                     self.titleLabel5.centerYAnchor.constraint(equalTo: self.bgView1.centerYAnchor)
        ...
        self.backGroundView1.addSubview(self.viewUnderLine)
          ...
          bgView1.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(addContactAction(sender:))))
