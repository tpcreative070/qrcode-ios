...
import UIKit
public class ICCheckBox: UIControl {
    ...
    /// **Default:** White.
    public var checkboxBackgroundColor: UIColor! = AppColors.WHITE_COLOR
    ...
    private func setupDefaults() {
        ...
        uncheckedBorderColor = AppColors.BLUE_COLOR
        checkedBorderColor = AppColors.BLUE_COLOR
        checkmarkColor = AppColors.BLUE_COLOR
