 ...
 */
@IBDesignable
open class ICTextFieldNoneIcon: UITextField { // swiftlint:disable:this type_body_length
    /**
    ...
    */
    ...
    required public init?(coder aDecoder: NSCoder) {
        ...
        titleFont = AppFonts.moderateScale(fontName: AppFonts.SFranciscoRegular, size: AppFonts.FLOAT_PLACEHOLDER_FONT_SIZE)
    }
    ...
    fileprivate func addEditingChangedObserver() {
        self.addTarget(self, action: #selector(ICTextFieldNoneIcon.editingChanged), for: .editingChanged)
    }
