...
extension TableViewCell  {
    ...
    func setupEventView(){
        ...
        viewRoot.addSubview(titleLabel4)
        NSLayoutConstraint.activate([
            titleLabel4.topAnchor.constraint(equalTo: valueTxt3.bottomAnchor, constant: 10),
            titleLabel4.leadingAnchor.constraint(equalTo: viewRoot.leadingAnchor, constant: AppConstants.MARGIN_LEFT),
            titleLabel4.trailingAnchor.constraint(equalTo: viewRoot.trailingAnchor, constant:  AppConstants.MARGIN_RIGHT)
        ])
        viewRoot.addSubview(valueTxt4)
        NSLayoutConstraint.activate([
            valueTxt4.topAnchor.constraint(equalTo: titleLabel4.bottomAnchor, constant: 0),
            valueTxt4.leadingAnchor.constraint(equalTo: viewRoot.leadingAnchor, constant: AppConstants.MARGIN_LEFT),
            valueTxt4.trailingAnchor.constraint(equalTo: viewRoot.trailingAnchor, constant:  AppConstants.MARGIN_RIGHT)
        ])
        viewRoot.addSubview(titleLabel5)
        NSLayoutConstraint.activate([
            titleLabel5.topAnchor.constraint(equalTo: valueTxt4.bottomAnchor, constant: 10),
            titleLabel5.leadingAnchor.constraint(equalTo: viewRoot.leadingAnchor, constant: AppConstants.MARGIN_LEFT),
            titleLabel5.trailingAnchor.constraint(equalTo: viewRoot.trailingAnchor, constant:  AppConstants.MARGIN_RIGHT)
        ])
        viewRoot.addSubview(valueTxt5)
        NSLayoutConstraint.activate([
            valueTxt5.topAnchor.constraint(equalTo: titleLabel5.bottomAnchor, constant: 0),
            valueTxt5.leadingAnchor.constraint(equalTo: viewRoot.leadingAnchor, constant: AppConstants.MARGIN_LEFT),
            valueTxt5.trailingAnchor.constraint(equalTo: viewRoot.trailingAnchor, constant:  AppConstants.MARGIN_RIGHT)
        ])
        self.backGroundView1.addSubview(bgView1)
                        NSLayoutConstraint.activate([
                            ...
                            self.bgView1.topAnchor.constraint(equalTo: self.valueTxt5.bottomAnchor,constant: 20),
                            
                        ])
        
        bgView1.addSubview(eventImg)
        NSLayoutConstraint.activate([
            eventImg.topAnchor.constraint(equalTo: bgView1.topAnchor, constant: 10),
            eventImg.leadingAnchor.constraint(equalTo: bgView1.leadingAnchor, constant: AppConstants.MARGIN_LEFT),
            self.eventImg.widthAnchor.constraint(equalToConstant: 30),
            self.eventImg.heightAnchor.constraint(equalToConstant: 30),
            self.eventImg.centerYAnchor.constraint(equalTo: self.bgView1.centerYAnchor)
            
        ])
        bgView1.addSubview(titleLabel6)
        NSLayoutConstraint.activate([
            titleLabel6.topAnchor.constraint(equalTo: bgView1.topAnchor, constant: 10),
            titleLabel6.leadingAnchor.constraint(equalTo: eventImg.trailingAnchor, constant: AppConstants.MARGIN_LEFT),
            titleLabel6.trailingAnchor.constraint(equalTo: bgView1.trailingAnchor, constant:  AppConstants.MARGIN_RIGHT),
            self.titleLabel6.centerYAnchor.constraint(equalTo: self.bgView1.centerYAnchor)
          ...
          self.backGroundView1.addSubview(clipboardView)
                             ...
                             bgView1.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(eventAction(sender:))))
