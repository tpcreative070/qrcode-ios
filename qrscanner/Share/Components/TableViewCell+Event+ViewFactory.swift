...
extension TableViewCell  {
    ...
    func setupEventView(){
        ...
        NSLayoutConstraint.activate([
            lbTitleFive.topAnchor.constraint(equalTo: textFieldValueFour.bottomAnchor, constant: 10),
        ...
        NSLayoutConstraint.activate([
            textFieldValueFive.topAnchor.constraint(equalTo: lbTitleFive.bottomAnchor, constant: 0),
        ...
        self.viewBackgroundSecond.addSubview(viewBackgroundThird)
                        NSLayoutConstraint.activate([
                            ...
                            self.viewBackgroundThird.topAnchor.constraint(equalTo: self.textFieldValueFive.bottomAnchor,constant: 20),
                            
                        ])
        
        viewBackgroundThird.addSubview(imgEvent)
        NSLayoutConstraint.activate([
            imgEvent.topAnchor.constraint(equalTo: viewBackgroundThird.topAnchor, constant: 10),
            imgEvent.leadingAnchor.constraint(equalTo: viewBackgroundThird.leadingAnchor, constant: AppConstants.MARGIN_LEFT),
            self.imgEvent.widthAnchor.constraint(equalToConstant: 30),
            self.imgEvent.heightAnchor.constraint(equalToConstant: 30),
        ...
        NSLayoutConstraint.activate([
            lbTitleSix.topAnchor.constraint(equalTo: viewBackgroundThird.topAnchor, constant: 10),
