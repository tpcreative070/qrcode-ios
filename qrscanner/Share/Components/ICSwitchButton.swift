...
import UIKit
@IBDesignable
final class ICSwitchButton: UIControl {
    ...
    // thumb properties
    @IBInspectable public var thumbTintOnColor: UIColor = UIColor.white {
        didSet {
            self.thumbView.backgroundColor = self.thumbTintOnColor
        }
    }
    
    @IBInspectable public var thumbTintOffColor: UIColor = UIColor.white {
        didSet {
    ...
    fileprivate var thumbView = ICCustomThumbView(frame: CGRect.zero)
...
extension ICSwitchButton {
    ...
    fileprivate func setupUI() {
        ...
        self.thumbView.backgroundColor = self.isOn ? self.thumbTintOnColor : self.thumbTintOffColor
    ...
    /**
     Handle animation when switch button
     */
...
extension ICSwitchButton {
    public override func layoutSubviews() {
        ...
        if !self.isAnimating {
            ...
            let thumbSize = self.thumbSize != CGSize.zero ? self.thumbSize : CGSize(width: 10, height: self.bounds.height - 2)
