...
extension TableViewCell  {
    ...
    func setupMessageView(){
        ...
        NSLayoutConstraint.activate([
            ...
            self.bgView1.topAnchor.constraint(equalTo: self.valueTxt2.bottomAnchor,constant: 20),
            
        ])
        
        
        bgView1.addSubview(smsImg)
        NSLayoutConstraint.activate([
            smsImg.topAnchor.constraint(equalTo: bgView1.topAnchor, constant: 10),
            smsImg.leadingAnchor.constraint(equalTo: bgView1.leadingAnchor, constant: AppConstants.MARGIN_LEFT),
            self.smsImg.widthAnchor.constraint(equalToConstant: 30),
            self.smsImg.heightAnchor.constraint(equalToConstant: 30),
            self.smsImg.centerYAnchor.constraint(equalTo: self.bgView1.centerYAnchor)
            
        ])
        bgView1.addSubview(titleLabel3)
        NSLayoutConstraint.activate([
            titleLabel3.topAnchor.constraint(equalTo: bgView1.topAnchor, constant: 10),
            titleLabel3.leadingAnchor.constraint(equalTo: smsImg.trailingAnchor, constant: AppConstants.MARGIN_LEFT),
        ...
        viewRoot.addSubview(clipboardView)
        NSLayoutConstraint.activate([
        ...
        bgView1.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(messageAction(sender:))))
