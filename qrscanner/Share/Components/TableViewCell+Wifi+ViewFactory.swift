...
extension TableViewCell  {
    ...
    func setupWifiView(){
        ...
        NSLayoutConstraint.activate([
            ...
            self.imgWifi.widthAnchor.constraint(equalToConstant: AppConstants.ICON_WIDTH_HEIGHT),
            self.imgWifi.heightAnchor.constraint(equalToConstant: AppConstants.ICON_WIDTH_HEIGHT),
