...
extension TableViewCell  {
    ...
    func setupWifiView(){
        ...
        bgView1.addSubview(wifiImg)
        NSLayoutConstraint.activate([
            wifiImg.topAnchor.constraint(equalTo: bgView1.topAnchor, constant: 10),
            wifiImg.leadingAnchor.constraint(equalTo: bgView1.leadingAnchor, constant: AppConstants.MARGIN_LEFT),
            self.wifiImg.widthAnchor.constraint(equalToConstant: 30),
            self.wifiImg.heightAnchor.constraint(equalToConstant: 30),
            self.wifiImg.centerYAnchor.constraint(equalTo: self.bgView1.centerYAnchor)
            
        ])
        bgView1.addSubview(titleLabel5)
        NSLayoutConstraint.activate([
            titleLabel5.topAnchor.constraint(equalTo: bgView1.topAnchor, constant: 10),
            titleLabel5.leadingAnchor.constraint(equalTo: wifiImg.trailingAnchor, constant: AppConstants.MARGIN_LEFT),
        ...
        bgView1.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(wifiAction(sender:))))
