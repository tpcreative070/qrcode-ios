...
//        didSet {
//          //  tableView.register(DropDownCell.self, forCellReuseIdentifier: EnumIdentifier.Dropdown.rawValue)
...
//            templateCell = tableView.dequeueReusableCell(withIdentifier: self.cellIdentifier, for: indexPath) as! DropDownCell
        }
